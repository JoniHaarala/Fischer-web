...
const Footer = () => {
    return (
        <footer className="flex flex-col bg-components-color text-white">
            <div className="w-full py-5 max-w-7xl items-center md:flex md:justify-between self-center border-b-2 border-white">
            ...
            <div className="w-full py-5 max-w-7xl px-10 grid grid-cols-3 justify-items-center self-center border-b-2 border-white">
                <p>hola mundo</p>
                <p>hola mundo</p>
                <p>hola mundo</p>
                <p>hola mundo</p>
            ...
            <p className='max-w-7xl text-white text-sm self-center pt-10 pb-3'>©2022 Fischer Inmobiliaria Argentina S.L.</p>
        </footer>
    )
}
